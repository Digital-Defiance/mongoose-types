declare module 'mongoose' {
   ...
   * *  T - the type of _id (can be ObjectId, string, or any custom type)
   * *  TQueryHelpers - Object with any helpers that should be mixed into the Query type
   * *  DocType - the type of the actual Document created
   */
  class Document<T = any, TQueryHelpers = any, DocType = any, TVirtuals = Record<string, any>, TSchemaOptions = {}> {
    constructor(doc?: any);
